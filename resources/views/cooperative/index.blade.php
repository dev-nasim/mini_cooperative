                    ...
                    <div class="col-md-8">
                        <nav class="d-none d-md-block" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cooperative List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{ route('cooperative.create') }}" class="btn btn-primary">
                            <i class="gd gd-plus"></i> Add New
                        </a>
                    </div>
                </div>

                <form method="GET" action="{{ route('cooperative.index') }}" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                    <div class="position-relative">
                                        <a href="{{ route('cooperative.edit', $d->id) }}" class="link-dark d-inline-block" title="Edit User">
                                            <i class="gd-pencil icon-text"></i>
                                        </a>

                                        <form action="{{ route('cooperative.destroy', $d->id) }}" method="POST" style="display: inline;" class="delete-form">
                                            @csrf
                                            @method('DELETE')
