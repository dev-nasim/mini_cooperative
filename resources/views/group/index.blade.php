    ...
    <div class="py-4 px-3 px-md-4">
        <div class="card mb-3 mb-md-4">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('group.index') }}" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                    <div class="position-relative">
                                        <a href="{{ route('group.edit', $d->id) }}" class="link-dark d-inline-block" title="Edit User">
                                            <i class="gd-pencil icon-text"></i>
                                        </a>

                                        <form action="{{ route('group.destroy', $d->id) }}" method="POST" style="display: inline;" class="delete-form">
                                            @csrf
                                            @method('DELETE')
