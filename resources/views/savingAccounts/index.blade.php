    ...
    <div class="py-4 px-3 px-md-4">
        <div class="card mb-3 mb-md-4">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('saving_accounts.index') }}" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
                            <input type="text" name="search" class="form-control" placeholder="Search by name,member code/saving code" value="{{ request('search') }}">
                        </div>
                        <div class="col-md-1">
